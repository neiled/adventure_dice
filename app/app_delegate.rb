class AppDelegate
  def application(application, didFinishLaunchingWithOptions:launchOptions)
    ...
    favourites_navigation_controller = UINavigationController.alloc.initWithRootViewController(dice_favourites_controller)
    ...
    tab_controller.viewControllers = [dice_bag_controller, favourites_navigation_controller, settings_navigation_controller]
